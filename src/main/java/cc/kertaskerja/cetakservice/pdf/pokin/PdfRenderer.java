...
import cc.kertaskerja.cetakservice.pdf.pokin.JenisPohon.Palette;
...
public class PdfRenderer {
        ...
        private void drawHeader(
                ...
                ShapeUtils.drawHorizontalGradientRect(
                                content,
                                x, headerY,
                                BOX_WIDTH, BOX_HEADER_HEIGHT,
                                node.getNode().jenisPohon().getColorAwal(),
                                node.getNode().jenisPohon().getColorAkhir());
